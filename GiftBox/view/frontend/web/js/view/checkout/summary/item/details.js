...
define(
    ...
    function ($, Component, quote, confirm, removeItemAction, updateItemAction, $t, ko, configurable, priceOptions) {
        ...
        return Component.extend({
            defaults: {
                template: 'BroSolutions_GiftBox/checkout/summary/item/details'
            },
            ...
            getGiftchildren: function(quoteItem) {
                var itemProduct = this.getItemFromQuote(quoteItem);

                return itemProduct.gifts;
            },
